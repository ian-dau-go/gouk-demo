        ...
        <div class="row mx-auto">
                    <div class="py-5 px-4">
                        <div class="row mx-auto frame9534">
                            <div
                                class="col-12 col-md-7 col-lg-8 col-xl-8 LetGoldenOwlConsultingBeYourItConsultant fz-m">
                                ...
                                <span
                                    style="color: white; font-family: Montserrat; font-weight: 500;word-wrap: break-word">be
                            ...
                            <div class="col-12 col-md-5 col-lg-4 col-xl-4 d-flex flex-column align-items-end">
                                <a class="frame9529 text-decoration-none" href="https://goldenowl.asia/contact-us"
                                    ...
                                    <div class="FiRrAngleSmallRight"
                                        style="width: 10%; height: 22px; position: relative">
