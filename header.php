...
<head>
    ...
    <title>
        <?php if (isset($args['title'])) { echo $args['title'];} else { echo 'Unknow page'; } ?>
    </title>
...
<body>
    <div style="height: 100vh"
        <?php echo isset($args['active']) && $args['active'] === 'blog' ? 'class="gouk__blog-page gouk-article"':'' ?>>
        <div class style="background: white">
            <section
                style="background: <?php echo isset($args['active']) && $args['active'] === 'blog' ? '#FFFBEB' :'white' ?>">
